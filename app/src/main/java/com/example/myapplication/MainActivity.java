...
public class MainActivity extends AppCompatActivity {
    ...
    int b1,b2,b3,b4,b5,b6,b7,b8,b9=5,xCount=0,yCount=0,i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scorex = findViewById(R.id.x_score);
        scoreo = findViewById(R.id.y_score);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                scorex.setText("Score of x:- "+ String.valueOf(xCount));
                scoreo.setText("Score of O:- "+ String.valueOf(yCount));
    ...
    private void winningGame(){
        ...
        else if((b1==0) && (b2==0) &&(b3==0))
        {
            ...
            alertDialog.show();
            yCount++;
            scoreo.setText("Score of y:- "+ String.valueOf(yCount));
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Player 2 wins").setCancelable(true).setPositiveButton("ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
